...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> manejarAutorizacionDenegada(
                ...
                log.error("[POS/GlobalExceptionHandler] - MANEJAR_AUTORIZACION_DENEGADA: errorMessage: {}",
                                e.getMessage());
                final ErrorResponse error = new ErrorResponse(
                                HttpStatus.FORBIDDEN.value(),
                                "Acceso denegado",
        ...
        public ResponseEntity<ErrorResponse> manejarAutenticacionFallida(
                ...
                log.warn("[POS/GlobalExceptionHandler] - MANEJAR_AUTENTICACION_FALLIDA: {}",
        ...
        public ResponseEntity<ErrorResponse> manejarResourceNotFound(final ResourceNotFoundException e) {
                log.error("[POS/GlobalExceptionHandler] - MANEJAR_RESOURCE_NOT_FOUND: errorMessage: {}",
                                e.getMessage());
                final ErrorResponse error = new ErrorResponse(
        ...
        public ResponseEntity<ErrorResponse> manejarIntegridadDeDatos(
                ...
                log.error("[POS/GlobalExceptionHandler] - MANEJAR_INTEGRIDAD_DATOS: {}",
        ...
        @ExceptionHandler({
                        ...
                        ArchivoDemasiadoGrandeException.class
        })
        public ResponseEntity<ErrorResponse> manejarArchivoDemasiadoGrande(final Exception e) {
                log.error("[POS/GlobalExceptionHandler] - ARCHIVO_DEMASIADO_GRANDE: errorMessage: {}", e.getMessage());
                final ErrorResponse error = new ErrorResponse(
                                HttpStatus.CONTENT_TOO_LARGE.value(),
                                "Archivo demasiado grande",
                                "El archivo excede el tamaño máximo permitido de 4 MB",
                                LocalDateTime.now());
